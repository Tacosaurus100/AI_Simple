...
PlayerWhite::PlayerWhite(Square*** squares) {
   ...
   if (GUI) {
      ...
      pieces[0] = new Piece ("a2", true, "pawn");
      pieces[1] = new Piece ("b2", true, "pawn");
      pieces[2] = new Piece ("c2", true, "pawn");
      pieces[3] = new Piece ("d2", true, "pawn");
      pieces[4] = new Piece ("e2", true, "pawn");
      pieces[5] = new Piece ("f2", true, "pawn");
      pieces[6] = new Piece ("g2", true, "pawn");
      pieces[7] = new Piece ("h2", true, "pawn");
      pieces[8] = new Piece ("a1", true, "rook"); 
      pieces[9] = new Piece ("h1", true, "rook");
      pieces[10] = new Piece ("b1", true, "knight"); 
      pieces[11] = new Piece ("g1", true, "knight");
      pieces[12] = new Piece ("c1", true, "bishop"); 
      pieces[13] = new Piece ("f1", true, "bishop");
      pieces[14] = new Piece ("d1", true, "queen");
      pieces[15] = new Piece ("e1", true, "king");
   }
}
